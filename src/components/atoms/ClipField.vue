  ...
  <div class="clip-field">
    <div class="clip-section">
     ...
     <div class="relative"> <input class="input break-all bg-transparent text-transparent" id="clip_url" placeholder="URL"
        v-model="clipField.clip_url" /><a class="text-blue-600 left-0 clip_url_link" id="clip_url_link" target="_blank" @click="redirectTo(clipField.clip_url)">{{clipField.clip_url}}</a></div>
    </div>
